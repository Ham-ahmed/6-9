...
echo -e "${CYAN}"
echo "#########################################################"
echo "#      Start downloading and installing  xklass         #"
echo "#########################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/6-9/refs/heads/main/enigma2-plugin-extensions-xklass_1.66.20250920_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.66.20250920_all.ipk"
...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}✓ xklass has been downloaded successfully....${NC}"
else
    echo -e "${RED}✗ Failed to download xklass...${NC}"
    exit 1
fi
